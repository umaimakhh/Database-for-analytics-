...
#testing 1c
sqlCountTweetTablee = "select * from TweetTablee;"
sqlCountuser_Dictionaryy = """select * from user_Dictionaryy;"""
sqCountGEOTable = """select * from GEOTable;"""
queryFetchsqlCountTweetTablee = cursor.execute(sqlCountTweetTablee).fetchall()
queryFetchCountsqluser_Dictionaryy = cursor.execute(sqlCountuser_Dictionaryy).fetchall()
# queryFetchCountsqlGEOTable = cursor.execute(sqCountGEOTable).fetchall()
print("-- \n Tweet Main table count" )
print(len(queryFetchsqlCountTweetTablee))
print("-- \n User Dictionary table count" )
print(len(queryFetchCountsqluser_Dictionaryy))
print("--\n Geo table count" )
print(len(queryFetchCountsqlGEOTable))
